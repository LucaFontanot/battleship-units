package it.units.battleship.view.core;
...
import it.units.battleship.view.core.game.GamePanel;
...
public class BattleshipFrame extends JFrame implements BattleshipView {
    ...
    public void showEndGamePhase(String message) {
        SwingUtilities.invokeLater(() -> {
            gamePanel.showEndGamePhase(message);
    ...
    public void setReturnToMenuAction(Runnable action) {
        gamePanel.setReturnToMenuAction(action);
    }

    @Override
    public void setReturnToMenuVisible(boolean visible) {
        gamePanel.setReturnToMenuVisible(visible);
    }
