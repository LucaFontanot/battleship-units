...
import static battleship.controller.http.HttpClient.JSON;
import static battleship.controller.http.HttpClient.client;

public class JsonHttpController<R, E> {
     ...
     */
    public JsonHttpController(Class<R> responseClass, Class<E> errorClass) {
     ...
     */
    public JsonHttpController(TypeToken<R> responseClass, TypeToken<E> errorClass) {
        gsonBuilder.serializeNulls();
     ...
     * @param errorClass the class of the error type
     */
    public JsonHttpController(TypeToken<R> responseClass, Class<E> errorClass) {
        gsonBuilder.serializeNulls();
        this.responseClass = responseClass;
        this.errorClass = TypeToken.get(errorClass);
    }
